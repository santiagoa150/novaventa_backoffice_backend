...
export class ProductDto {
  @ApiProperty()
  @IsNotEmpty({ message: ValidationMessagesConstants.PRODUCT_ID_REQUIRED })
  @IsString({ message: ValidationMessagesConstants.PRODUCT_ID_MUST_BE_STRING })
  @IsUUID(4, { message: ValidationMessagesConstants.INVALID_PRODUCT_ID_FORMAT })
      productId: string;
